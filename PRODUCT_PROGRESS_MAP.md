...
|------|--------------------------|:------------:|-------------------|------------------------|-------------------------------|
| [01](roadmap/week-01-project-understanding/README.md) | Project proposal, architecture diagram, syllabus mapping, Git repo, 12-week plan | **5%** | Exist as a fully planned product: every screen, layer, and data flow is designed on paper | Run at all — no code exists yet | Walk through the architecture diagram end-to-end and explain every component and arrow |
| [02](roadmap/week-02-android-basics-ui/README.md) | Android project, MainActivity + 3 more screens, XML layouts, Intent navigation, string/color resources | **15%** | Launch on an emulator and navigate between 4+ real screens | Take photos, analyze anything, or store anything | Launch the app and tap through every screen and back |
| [03](roadmap/week-03-camera-gallery/README.md) | Camera capture, gallery picker, runtime permissions, image display | **25%** | Capture a leaf photo (or pick one from gallery) and show it on screen, handling permission denial gracefully | Analyze the photo — no backend, no AI | Capture a photo with the camera, then pick one from the gallery, and see both displayed |
