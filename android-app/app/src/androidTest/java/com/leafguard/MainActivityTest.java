...
/**
 * Java twin of MainActivityTest.kt — UI (instrumented) test that launches the
 * real MainActivity on an emulator or a connected phone and checks that the two
 * capture buttons are on screen.
 *
